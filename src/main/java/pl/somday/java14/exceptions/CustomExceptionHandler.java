...
import pl.somday.java14.avatar.AvatarStorageException;
import pl.somday.java14.security.user.UserAlreadyExistsException;
...
public class CustomExceptionHandler {
    ...
    @ResponseBody
    public ErrorResponse handleGlobalException(final Exception exp) {
